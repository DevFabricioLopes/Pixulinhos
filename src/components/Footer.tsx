...
export const Footer: React.FC<FooterProps> = ({ settings, onSelectCategory }) => {
  ...
  return (
    <footer className="bg-[#1C1738] text-white pt-12 pb-8 border-t-4 border-[#FF3B7A]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 text-center md:text-left">
          ...
          <div className="md:col-span-3 space-y-3">
            <h4 className="text-sm font-bold uppercase tracking-wider text-amber-300">Coleções Especiais</h4>
          ...
          <div className="md:col-span-4 space-y-3">
            <h4 className="text-sm font-bold uppercase tracking-wider text-amber-300">Atendimento Humanizado</h4>
            <div className="space-y-2 text-xs text-gray-300">
              <p className="flex items-center justify-center md:justify-start gap-2">
                <MapPin className="w-4 h-4 text-[#FF3B7A]" />
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-400">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-center sm:text-left">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-xs text-pink-200 hover:text-white transition-colors font-medium bg-white/5 px-3 py-1 rounded-full border border-white/10 hover:border-[#FF3B7A]"
            >
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={scrollToTop}
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#FF3B7A] hover:bg-[#e02e6b] text-white text-[11px] font-extrabold shadow-xs transition-all transform hover:-translate-y-0.5"
            >
